...
$ricSql2Rule0=new Lex_rule("regola0");
$ricSql2Rule1=new Lex_rule("regola1");
$ricSql2Rule2=new Lex_rule("regola2");
$ricSql2Rule3=new Lex_rule("regola3");
$ricSql2Rule4=new Lex_rule("regola4");
$ricSql2Rule5=new Lex_rule("regola5");
$ricSql2Rule6=new Lex_rule("regola6");
$ricSql2Rule7=new Lex_rule("regola7");
$ricSql2Rule8=new Lex_rule("regola8");
$ricSql2Rule9=new Lex_rule("regola9");
$ricSql2Rule10=new Lex_rule("regola10");
$ricSql2Rule11=new Lex_rule("regola11");
$ricSql2Rule12=new Lex_rule("regola12");
$ricSql2Rule13=new Lex_rule("regola13");
$ricSql2Rule14=new Lex_rule("regola14");
$ricSql2Rule15=new Lex_rule("regola15");
$ricSql2Rule16=new Lex_rule("regola16");
$ricSql2Rule17=new Lex_rule("regola17");
$ricSql2Rule18=new Lex_rule("regola18");
$ricSql2Rule19=new Lex_rule("regola19");
$ricSql2Rule20=new Lex_rule("regola20");
$ricSql2Rule21=new Lex_rule("regola21");
$ricSql2Rule22=new Lex_rule("regola22");
...
$ricSql2Rule11->setRegexp("/^[\*]/");
$ricSql2Rule11->setTokenType(Token::TYPE_SPECIAL_ITEM);
$ricSql2Rule11->setTokenVal(RIC_SQL_2_TOKEN_VAL_STAR);

$ricSql2Rule12->setRegexp("/^(count|avg|sum)(?=\()/i");
$ricSql2Rule12->setTokenType(Token::TYPE_SPECIAL_ITEM);
$ricSql2Rule12->setTokenVal(RIC_SQL_2_TOKEN_VAL_FUN_HEAD);

$ricSql2Rule13->setRegexp("/^([+-]?[1-9][0-9]*)|[+-]?[0-9]*[\.][0-9]/");
$ricSql2Rule13->setTokenType(Token::TYPE_SPECIAL_ITEM);
$ricSql2Rule13->setTokenVal(RIC_SQL_2_TOKEN_VAL_NUM);

$ricSql2Rule14->setRegexp("/^([\+\-\/]|AND(?=(\b)|(\())|OR(?=(\b)|(\()))/i");
$ricSql2Rule14->setTokenType(Token::TYPE_SPECIAL_ITEM);
$ricSql2Rule14->setTokenVal(RIC_SQL_2_TOKEN_VAL_OP);

$ricSql2Rule15->setRegexp("/^(<>|<=|>=|>|<|=|like(?=(\b)|(\()))/i");
$ricSql2Rule15->setTokenType(Token::TYPE_SPECIAL_ITEM);
$ricSql2Rule15->setTokenVal(RIC_SQL_2_TOKEN_VAL_RELOP);

$ricSql2Rule16->setRegexp("/^([A-Za-z][A-Za-z0-9_]*)/");
$ricSql2Rule16->setTokenType(Token::TYPE_LEXICAL_ELEMENT);
$ricSql2Rule16->setTokenVal(RIC_SQL_2_TOKEN_VAL_ITEM);

$ricSql2Rule17->setRegexp("/^[\s]+/");
$ricSql2Rule17->setTokenType(Token::TYPE_DELIM);
$ricSql2Rule17->setTokenVal(RIC_SQL_2_TOKEN_VAL_WS);

$ricSql2Rule18->setRegexp("/^,/");
$ricSql2Rule18->setTokenType(Token::TYPE_SPECIAL_ITEM);
$ricSql2Rule18->setTokenVal(RIC_SQL_2_TOKEN_VAL_COMMA);

$ricSql2Rule19->setRegexp("/^\./");
$ricSql2Rule19->setTokenType(Token::TYPE_SPECIAL_ITEM);
$ricSql2Rule19->setTokenVal(RIC_SQL_2_TOKEN_VAL_POINT);

$ricSql2Rule20->setRegexp("/^\(/");
$ricSql2Rule20->setTokenType(Token::TYPE_SPECIAL_ITEM);
$ricSql2Rule20->setTokenVal(RIC_SQL_2_TOKEN_VAL_OPEN_PAR);

$ricSql2Rule21->setRegexp("/^\)/");
$ricSql2Rule21->setTokenType(Token::TYPE_SPECIAL_ITEM);
$ricSql2Rule21->setTokenVal(RIC_SQL_2_TOKEN_VAL_CLOSE_PAR);

$ricSql2Rule22->setRegexp("/^(\"[a-zA-Z0-9_,:\.;\\\|!\$\/\(\)=\?\^\[\]@#]*\")|('[a-zA-Z0-9_,:\.;\\\|!\$\/\(\)=\?\^\[\]@#]*')/");
$ricSql2Rule22->setTokenType(Token::TYPE_SPECIAL_ITEM);
$ricSql2Rule22->setTokenVal(RIC_SQL_2_TOKEN_VAL_SSTRING);

define('RIC_SQL_2_LEX_RULE_CONTAINER_0',"Contenitore_regole_0");

$ricSql2DefRules=new Lex_rules_container(RIC_SQL_2_LEX_RULE_CONTAINER_0);
...
$ricSql2DefGrRules=new Parser_grammar_rules_container(RIC_SQL_2_PARSER_GRAMMAR_RULE_CONTAINER_1);
